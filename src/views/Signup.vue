                ...
                <form class="w-full max-w-lg" @submit.prevent="register">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input v-model="location"
                                class="appearance-none block w-full bg-gray-800 text-gray-700 border border-gray-900 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-city" type="text" placeholder="Location">
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                for="grid-zip">
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        <div class="flex items-center">
                            <label for="remember_me"
                                class="ml-2 block text-sm leading-5 text-white hover:text-indigo-500">
                        ...
                        <div class="text-sm leading-5">
                            <router-link to="/signinadmin"
                                class="font-medium text-yellow-800 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
                                Admin Area
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-center text-sm leading-5 text-yellow-800 max-w">
                            This is the Signup area,click
                            <router-link to="/"
                                class="font-medium text-white-800 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
                                Homepage
                            </router-link>
                        </p>
                    </div>
